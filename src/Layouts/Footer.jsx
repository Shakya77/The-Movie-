...
export default function Footer() {
    ...
    return (
        <footer className="absolute bottom-0 w-full bg-white shadow-sm dark:bg-gray-900 ">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <button onClick={handleNavigate} className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                ...
                <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">
                    © 2025 <button onClick={handleNavigate} className="hover:underline">Movie House</button>. All Rights Reserved.
                </span>
            </div>
        </footer>
    );
